...
writefile("library/Circle.png", Circle.Body)
...
writefile("library/ColorDropper.png", ColorDropper.Body)
...
writefile("library/Close.png", Close.Body)
...
writefile("library/CollapseArrow.png", CollapseArrow.Body)
...
writefile("library/RadioButton.png", RadioButton.Body)
...
writefile("library/RadioOuter.png", RadioOuter.Body)
...
writefile("library/RadioInner.png", RadioInner.Body)
...
Info.Text = Info.Text or "library"
...
radioButtonIcon.Image = getcustomasset("library/CollapseArrow.png")
...
radioButtonIcon2.Image = getcustomasset("library/RadioButton.png")
...
radioOuter.Image = getcustomasset("library/RadioOuter.png")
...
radioInner.Image = getcustomasset("library/RadioInner.png")
